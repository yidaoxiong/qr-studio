...
- **界面三语**：中文 / English / Español，右上角切换，选择记在 localStorage
  （只翻译界面；二维码内容、字体、导出结果不受语言影响）
...
src/
  index.html          页面骨架（含 /*__CSS__*/ 等占位符与 data-i18n 标记）
  i18n.js             中 / 英 / 西 文案字典 + t() + applyStaticText()
  app.css             样式
